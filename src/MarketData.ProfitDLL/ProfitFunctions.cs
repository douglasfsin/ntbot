...
{
    private const string dll_path = @"dlls\ProfitDLL.dll";
    ...
    [DllImport(dll_path, CallingConvention = CallingConvention.StdCall)]
    public static extern int SubscribePriceDepth(TConnectorAssetIdentifier assetID);

    [DllImport(dll_path, CallingConvention = CallingConvention.StdCall)]
    public static extern int UnsubscribePriceDepth(TConnectorAssetIdentifier assetID);

    [DllImport(dll_path, CallingConvention = CallingConvention.StdCall)]
    public static extern int GetTheoreticalValues(TConnectorAssetIdentifier assetID, out double price, out long quantity);

    [DllImport(dll_path, CallingConvention = CallingConvention.StdCall)]
    public static extern int GetPriceDepthSideCount(TConnectorAssetIdentifier assetID, int side);

    [DllImport(dll_path, CallingConvention = CallingConvention.StdCall)]
    public static extern int GetPriceGroup(TConnectorAssetIdentifier assetID, int side, int position, ref TConnectorPriceGroup priceGroup);
}
