    ...
    public partial class AddIdentityTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OtpVerifications_OtpCode_VerificationType_ExpiresAt",
                table: "OtpVerifications",
                columns: new[] { "OtpCode", "VerificationType", "ExpiresAt" });

            migrationBuilder.CreateIndex(
                name: "IX_OtpVerifications_TenantId_VerificationType",
                table: "OtpVerifications",
                columns: new[] { "TenantId", "VerificationType" });

            migrationBuilder.CreateIndex(
                name: "IX_OtpVerifications_UserId_VerificationType",
                table: "OtpVerifications",
