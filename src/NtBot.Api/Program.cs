...
try
{
    ...
    builder.Services.Configure<QuantOptions>(builder.Configuration.GetSection(QuantOptions.SectionName));
    builder.Services.AddHttpClient(nameof(MarketCandleService));
